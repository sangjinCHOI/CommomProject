...
public class ContentController {
	...
	public ResponseEntity<String> hashtagCreate(@RequestParam(value = "hashtag[]") @ApiParam(value = "hashtag[]", required = true) List<String> hashtag, @PathVariable int contentSeq) {
